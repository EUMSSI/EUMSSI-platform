...
public class DebugResultSet implements ResultSet, Debuggable {

	DebugStatement father;

	static Hashtable<Integer, Statement> pstatements = new Hashtable<Integer, Statement>();
	String id;
	...
	public DebugResultSet(String id, DebugStatement father, ResultSet rs) {
		this.rs = rs;
		this.father = father;
		this.id = id;
	...
	@SuppressWarnings("deprecation")
	@Override
	public BigDecimal getBigDecimal(String columnIndex, int scale)
			throws SQLException {
		return rs.getBigDecimal(columnIndex, scale);
	}
