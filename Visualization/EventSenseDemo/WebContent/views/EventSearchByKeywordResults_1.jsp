...
<body>
    ...
    <s:iterator value="events" var="event">	
    	<div class="change">	
			...
			<s:iterator var="sources" value="#event.refs">
			<span>			
	...
	<s:iterator value="relatedCategories" var="catId" status="catList">	
	
		<s:set var="category" value="helper.returnCategoryById(#catId)" />
		<s:div id="#catId" class="cat" style="margin-left: 100px;"> 
		<a href="
						<s:if test="useContextPath != false">
	    					<s:url action="ShowStoryByCategory" includeContext="true">
								<s:param name="CategoryId" value="#catId" > </s:param>
							</s:url>
						</s:if>
						<s:else>
							<s:url action="ShowStoryByCategory" includeContext="false">
					...
					">
					<font color="#0040FF" ><s:property value="#category"/></font>
		</a> 
		</s:div>
	...
	<s:iterator value="relatedStories" var="stId" status="stList">	
	
		<s:set var="story" value="helper.returnStoryById(#stId)" />
		<s:div id="#stId" class="story" style="margin-left: 100px;"> 
		<a href="
				<s:if test="useContextPath != false">
	    			<s:url action="SearchEvent" includeContext="true">
						<s:param name="storyId" value="#stId" > </s:param>
					</s:url>
				</s:if>
				<s:else>
					<s:url action="SearchEvent" includeContext="false">
				...
				">
				<font color="#0040FF" ><s:property value="#story"/></font>
		</a> 
		</s:div>
	</s:iterator>
