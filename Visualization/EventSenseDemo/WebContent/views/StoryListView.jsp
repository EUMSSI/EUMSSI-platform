...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
    ...
    <html>
        <head>
            ...
            <title>WikiTimes - News Story List</title>
...
<body>
	...
	<div class="container">
		...
		<div style="margin-left: 100px">
			<h3 class="mainhead">
			List of <b><s:property value="stories.size()"/>&nbsp;News Stories</b> 
        ...
        <table id="displayTable" width="100%" border="0"  >
			...
			<thead>
	        	<tr>
	            	<th align="left"><h3 class="newhead" style="margin-left: 100px;">News Story</h3></th>
				...
				<tr>
					<td>
						<s:div id="#story.id" class="story" style="margin-left: 100px;">
							...
							<s:set var="storyUrl" value="#story.wikipediaUrl" />
