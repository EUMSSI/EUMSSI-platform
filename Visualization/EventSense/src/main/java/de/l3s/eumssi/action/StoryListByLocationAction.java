...
public class StoryListByLocationAction implements Action {
	...
	public String execute() throws Exception{
		...
		try {
			...
			if(fromDate == null || toDate == null)
				stories = helper.getStoryList(db.getEventsByLocation(locationId, null, null));
			else if (fromDate.isEmpty() || toDate.isEmpty())
				stories = helper.getStoryList(db.getEventsByLocation(locationId, null, null));
			else
				stories = helper.getStoryList(db.getEventsByLocation(locationId, fromDate, toDate));
		} catch (Exception e) {
			e.printStackTrace();
		}finally{
