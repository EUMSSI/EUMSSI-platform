...
<html>
    ...
    <body>
        ...
        <h3 class="mainhead">Profile of: <b><s:property value="entity.name"/></b> (<s:a href="%{entity.wikiURL}" >Wikipedia Page</s:a>)</h3>
        
        <h3 class="mainhead">Entity Timeline (<s:property value="searchsize"/> events):</h3>
